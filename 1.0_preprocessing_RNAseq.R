...
cts <-read.csv("FFP_cts.csv", row.names = 1, header = TRUE)##Samples with technological issues removed
cts <-read.csv("govaere_v3.csv", row.names = 1, header = TRUE)
cts <-read.csv("hoang_v3.csv", row.names = 1, header = TRUE)
#### Read metadata to order the samples based on F score
meta<-read.csv("ffp_meta.csv")#, row.names = 1)
meta<-read.csv("govaere_meta.csv", row.names = 1, header = TRUE)
meta<-read.csv("hoang_meta.csv", row.names = 1, header = TRUE)
...
write.csv(cts.2logr, "FFP_2rlog_visualization.csv")
write.csv(cts.2logr, "Govaere_2rlog_visualization.csv")
write.csv(cts.2logr, "Hoang_2rlog_visualization.csv")
